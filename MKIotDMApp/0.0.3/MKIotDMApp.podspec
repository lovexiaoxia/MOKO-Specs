...
LoginManager depends on Network only — lightweight for other private libraries.
  ...
  s.homepage         = 'https://github.com/lovexiaoxia/MKIotDMApp'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lovexiaoxia' => 'aadyx2007@163.com' }
  s.source           = { :git => 'https://github.com/lovexiaoxia/MKIotDMApp.git', :tag => s.version.to_s }
  ...
  s.subspec 'LoginManager' do |alert|
    alert.source_files = 'MKIotDMApp/Classes/Functions/LoginManager/**/*.{h,m}'
